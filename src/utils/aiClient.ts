...
`,
        ...
        // {
        //   role: "user",
        //   content: '[{"id":1,"content":"She  don\'t like apples."}]',
        // },
        // {
        //   role: "assistant",

        //   content:
        //     '[{"id":1,"items":[{"title":"Change the verb form","describe":["Replace ",{"text":"don\'t", "isBold":true}," with ",{"text":"doesn\'t", "isBold":true}," to correct the verb form."],"range":{"star":4,"end":9},"replacement":"doesn\'t"},{"title":"Remove extra space","describe":["Remove the extra space between words ",{"text":"  ", "isBold":true}," between \'She\' and \'don\'t\'."],"range":{"star":3,"end":5},"replacement":" "}]}]',
        // },
  ...
  const message = JSON.parse(contentJson);
  console.log(message);
