...
import {
  correctComments,
  correctSingleLineComment,
  correctTrackComment,
} from "../api/correctComments";
...
//     const input: string =
//       "/*\nThis is a block comment.\nThis block comment has an error: there is a dogs.\n*/";
//     const result = correctTrackComment(input);
//     expect(result).toBe(
//       "/**\n* This is a block comment.\n* This block comment has an error: there is a dogs.\n*/"
//     );
//   });
...
//     let result = correctSingleLineComment(input);
//     const expectedResult = "// There is a dogs here.";
//     expect(result).toBe(expectedResult);

//     input = "//There is a dogs here.";
//     result = correctSingleLineComment(input);
//     expect(result).toBe(expectedResult);
...
describe("", () => {
  test("", () => {
    ...
    const tests = [{ source: "There   is a dog", target: "There is a dog" }];
    for (const test of tests) {
      const result = wordLevenshteinDistance(test.source, test.target);
      console.log(`
        Source: ${test.source}
        Target: ${test.target}
